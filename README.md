...
wrote and understand some functions and comleted the script to extract text ,images and different things and add them in respective folders in the form of json format(messy one) (python_extractor.py)
